                    ...
                    <form action="{{ route('product.update', $product) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="summernote-simple form-control" name="description" rows="20" cols="20">{{ $product->description }}</textarea>

                            </div>
                            <div class="form-group">
                                <label>Image <span>upluod gambar jika ingin mengganti</span></label>
                                <br>
                                <img class="img-fluid my-3" src="{{ asset($product->image) }}" alt="">
                                <br>
